...
class FRIEND:
    ...
    """
    def __int__(self, number:int, name:str, age:int, country:str):
...
class WAREHOUSE:
    def __int__(self, cargo_turnover: Union[int, float], time_of_keeping:int, type_of_cargo:str, warehouse_area:int):
        """
...
class PANCAKE:
    def __int__(self, eggs:int, milk:int, sugar:int, flour:int):
        """
